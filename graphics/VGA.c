/* ============================================================================
 * VGA.c - PIO-based VGA (QVGA) core1 scanout
 *
 * Split out of PicoMite.c. Compiled only for VGA variants (see CMakeLists).
 * QVgaCore() is the core1 entry point, launched from PicoMite.c via
 * multicore_launch_core1_with_stack(). Was the #ifndef HDMI (VGA) branch of the
 * PICOMITEVGA scanout block. Shared core0<->core1 state is declared in
 * graphics/VGA.h.
 * ============================================================================ */
