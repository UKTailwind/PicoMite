"""Convert BLIT_User_Manual.md to PDF using fpdf."""
import re
...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'BLIT Command -- User Manual', 0, 1, 'C')
        self.ln(5)
...
render_markdown(pdf, 'BLIT_User_Manual.md')

pdf.output('BLIT_User_Manual.pdf')
print('Generated BLIT_User_Manual.pdf')
